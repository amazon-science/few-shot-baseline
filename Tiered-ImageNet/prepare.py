...
def main():
    ...
    for data_type in ['train', 'val', 'test']:
        ...
        pkl_file = os.path.join('tiered-imagenet', data_type + '_images_png.pkl')
        data = pickle.load(open(pkl_file, 'rb'))
        pkl_file = os.path.join('tiered-imagenet', data_type + '_labels.pkl')
        l = pickle.load(open(pkl_file, 'rb'))
        classes = l['label_specific_str']
        labels = l['label_specific']
